...
const ITEMS = [
  ...
  },
  {
    ...
    a: 'The Constitution sets an upper size limit on the federal district (100 sq. mi.) but no lower limit, and doesn\'t fix its location. A shrunken federal district (Mall, Capitol, White House, military sites) could remain while the rest becomes a state.',
  },
  {
    id: 'myth-8',
    type: 'myth',
